...
public static class GetViewsCommand
{
    public static Command Create(Option<string?> sessionOption)
    {
        ...
        var command = new Command("get-views", "Get supported views and current view via the MultipleView pattern");
        ...
        command.SetAction((ParseResult parseResult) =>
        {
            ...
            try
            {
                ...
                var result = AutomationEngine.GetMultipleViewInfo(element, elementId);

                CommandHelper.RecordStep(session, "elem get-views", elementId, null, true);

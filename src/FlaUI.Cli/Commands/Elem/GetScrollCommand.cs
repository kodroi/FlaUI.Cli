...
public static class GetScrollCommand
{
    public static Command Create(Option<string?> sessionOption)
    {
        ...
        var command = new Command("get-scroll", "Get scroll position and state via the Scroll pattern");
        ...
        command.SetAction((ParseResult parseResult) =>
        {
            ...
            try
            {
                ...
                var result = AutomationEngine.GetScrollInfo(element, elementId);

                CommandHelper.RecordStep(session, "elem get-scroll", elementId, null, true);

...
public static class MaximizeWindowCommand
{
    public static Command Create(Option<string?> sessionOption)
    {
        ...
        var command = new Command("maximize", "Maximize a window via the Window pattern");
        ...
        command.SetAction((ParseResult parseResult) =>
        {
            ...
            try
            {
                ...
                AutomationEngine.SetWindowVisualState(window, WindowVisualState.Maximized);
